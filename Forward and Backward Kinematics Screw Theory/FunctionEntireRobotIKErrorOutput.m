function [q_current,posError,rotError] = FunctionEntireRobotIKErrorOutput(dimensions,T,H,HArm2General,HGeneral2Arm,DesiredCenter,q_previous,GENERATE_PLOTS)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Author: Lucas Dubois
% Date: 09-apr-2025
% Description:
...
posError = {posErrorLB,posErrorRB, posErrorLF,posErrorRF};
rotError = {rotErrorLB, rotErrorRB, rotErrorLF, rotErrorRF};
